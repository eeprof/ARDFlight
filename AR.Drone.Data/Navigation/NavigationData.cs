...
namespace AR.Drone.Data.Navigation
{
	...
	public struct GPS
	{
		public System.Double latitude;	   // degrees dec
		public System.Double longitude;	  // degrees dec
		public System.Double elevation;	 // meters

		public override string ToString()
		{
			return string.Format("{{latitude(DecDeg):{0} longitude(DecDeg):{1} elevation(m):{2}}}", latitude, longitude, elevation);
		}
	}
