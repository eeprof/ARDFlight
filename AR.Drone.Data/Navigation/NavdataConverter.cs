...
namespace AR.Drone.Data.Navigation
{
    public static class NavdataConverter
    {
        ...
        public static NavigationData ToNavigationData(NavdataBag navdataBag)
        {
			...
			navigationData.GPS.latitude = navdataBag.navdata_gps.latitude;
			navigationData.GPS.longitude = navdataBag.navdata_gps.longitude;
			navigationData.GPS.elevation = navdataBag.navdata_gps.elevation;
