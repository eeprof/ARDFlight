...
namespace ARDrone.Input.InputConfigs
{
    class SpeechBasedInputConfig : InputConfig
    {
        ...
        {
			states.Add(_AXESHEADER, new InputConfigHeader("Axes", InputConfigState.Position.LeftColumn, 0));
			...
			states.Add(_BUTTONSHEADER, new InputConfigHeader("Buttons", InputConfigState.Position.RightColumn, 0));
