...
namespace AR.Drone.Client.Command
{
    public class ProgressCommand : AtCommand
    {
        ...
        protected override string ToAt(int sequenceNumber)
        {
			...
			return String.Format("AT*PCMD={0},{1},{2},{3},{4},{5}\r", sequenceNumber, (int)_mode, NormalizeValue(_roll), NormalizeValue(_pitch), NormalizeValue(_gaz), NormalizeValue(_yaw));
